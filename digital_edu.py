...
#print(df_train[["occupation_type", "occupatoin_name", "career_start", "career_end"].tail(20)])
...
# print(df_train.last_seen.head(50))

#df_train.info

#print(df_train.bdate.tail(25))
...
#print(df_train.education_form.value_counts)
...
X_train = df_train.drop(['result', 'langs'])
y_train = df_train.result

X_test = df_test.drop(['result', 'langs'])
